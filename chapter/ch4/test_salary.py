from chapter.ch4.monkey import salary


class TestSalary():

    def test_calculation_salary(self, mocker):
        s = salary.Salary(year=2017)
        s.bonus_api.bonus_price = mocker.patch('salary.ThirdPartryBonusRestAPi.bonus_price', return_value=1)
